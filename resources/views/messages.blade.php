            ...
            @if (Auth::check())
                ...
                <form action="/create" method="post">
                    <div class="form-group mb-3">
                        <input type="text" class="form-control" name="title" value="{{-- {{$message->title}} --}}" placeholder="Title" id="floatingInput" required>
                    </div>
                    ...
                    <div class="sender text-center">
                        <button type="submit" class="btn btn-circle mt-3 text-center"><i class="fa-brands fa-twitter fa-3x fa-flip" style="--fa-animation-duration: 30s; --fa-animation-iteration-count: 1;"></i></button>
                    </div>
                </form>
            @else
